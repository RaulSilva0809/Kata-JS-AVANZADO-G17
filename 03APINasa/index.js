...
const llave = "qiwmPAq05GasEOS8Vhy1XIYrIFIWM5Xh8hzHqjpk"
...
listaxDia.forEach((elemento,indice,arreglo)=>{
            if(elemento.is_potentially_hazardous_asteroid){
                console.log(`El meteorito ${elemento.name} es potencialmente peligroso. El diametro estimado es:${(((elemento.
estimated_diameter.meters.estimated_diameter_min)+(elemento.
estimated_diameter.meters.estimated_diameter_max))/2).toFixed
(2) } metros`)
            }
	else
	{
                console.log(`El meteorito ${elemento.name} NOO es potencialmente peligroso. El diametro estimado es: ${(((elemento.
estimated_diameter.meters.estimated_diameter_min)+(elemento.
estimated_diameter.meters.estimated_diameter_max))/2). toFixed
(2) } metros`)
            }
